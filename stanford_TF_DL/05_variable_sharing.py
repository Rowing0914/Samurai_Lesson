...
# logits1 = two_hiden_layers(x1)
# logits2 = two_hiden_layers(x2)

# with tf.variable_scope('two_layers') as scope:
#     logits1 = two_hiden_layers_2(x1)
#     scope.reuse_variables()
#     logits2 = two_hiden_layers_2(x2)
